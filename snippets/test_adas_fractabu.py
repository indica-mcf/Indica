...
ion = scd_W.interp(log_electron_temperature=np.log10(profs.te)).interp(log_electron_density=np.mean(np.log10(profs.ne)))
rec = acd_W.interp(log_electron_temperature=np.log10(profs.te)).interp(log_electron_density=np.mean(np.log10(profs.ne)))
lin_rad = plt_W.interp(log_electron_temperature=np.log10(profs.te)).interp(log_electron_density=np.mean(np.log10(profs.ne)))
rec_rad = prb_W.interp(log_electron_temperature=np.log10(profs.te)).interp(log_electron_density=np.mean(np.log10(profs.ne)))

drop = ["log_electron_temperature",
...
fz = DataArray(fz,
               ...
               coords=[("ion_charges", scd_W.coords["ion_charges"]),
                       ("rho_poloidal", rho)])
