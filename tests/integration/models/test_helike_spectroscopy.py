...
from indica.examples.example_transforms import example_helike_transform
...
class TestHelike:
    def setup_class(self):
        ...
        self.multiple_channel_los_transform = example_helike_transform(nchannels=3)
        self.single_channel_los_transform = example_helike_transform(nchannels=1)
