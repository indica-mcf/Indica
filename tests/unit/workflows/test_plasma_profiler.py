...
from indica.workflows.plasma_profiler import PlasmaProfiler, PLASMA_ATTRIBUTE_NAMES
...
class TestPlasmaProfiler:
    def setup_method(self):
        ...
        self.profilers = {
            ...
            for profile_name in ["electron_density", "ion_temperature", "impurity_density:ar"]
        }
    ...
    def test_change_plasma_profiles(self):
        ...
        assert all(self.plasma.impurity_density.sel(element="ar", rho_poloidal=0) == 1.02e19)
