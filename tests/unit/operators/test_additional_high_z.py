...
def test_calc_normalised_additional_high_z_density():
    ...
    n_additional_high_z_unnormalised = (
        n_additional_high_z_unnormalised_midplane * asymmetry_modifier
    )

    bolometry_obj = bolometry_object_setup(input_data)

    # insert density into bolometry obj
    n_additional_high_z_unnormalised = n_additional_high_z_unnormalised.transpose(
        "rho_poloidal", "theta", "t"
    )

    normalised_density = normalisation * n_additional_high_z_unnormalised
    ...
    normalisation_result = (
        n_additional_high_z / n_additional_high_z_unnormalised_midplane
    ).mean()
