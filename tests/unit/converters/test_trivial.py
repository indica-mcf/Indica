...
@composite
def trivial_transforms(draw):
    x1, x2, t = draw(arbitrary_coordinates())
...
def test_trivial_to_Rz(self, transform, coords):
...
@given(trivial_transforms(), arbitrary_coordinates())
def test_trivial_from_Rz(self, transform, coords):
    """Test trivial transform returns arguments."""
