...
READER_QUANTITIES: Dict[str, Dict[str, Tuple[str, list]]] = {
    ...
    "get_nbi": {
        ...
        "location": ("location", []),
        "direction": ("direction", []),
        "focus_height": ("focal_length", []),
        "focus_width": ("focal_length", []),
        "focal_length": ("focal_length", []),
        "div_width": ("divergence", []),
        "div_height": ("divergence", []),
        "spot_width": ("spot_height", []),
        "spot_height": ("spot_height", []),
        "spot_shape": ("spot_shape", []),
        "energy_components": ("beam_energy_components", []),
        "energy": ("beam_energy", ["t"]),
        "power": ("beam_power", ["t"]),
        "current_fraction": ("beam_current_fraction", ["t", "beam_energy_components"]),
        "power_fraction": ("beam_power_fraction", ["t", "beam_energy_components"]),
        "current_fraction1": ("beam_current_fraction", ["t"]),
        "current_fraction2": ("beam_current_fraction", ["t"]),
        "current_fraction3": ("beam_current_fraction", ["t"]),
        "power_fraction1": ("beam_power_fraction", ["t"]),
        "power_fraction2": ("beam_power_fraction", ["t"]),
        "power_fraction3": ("beam_power_fraction", ["t"]),
    },
    "get_solps": {
        "R": ("R", []),
        "z": ("z", []),
