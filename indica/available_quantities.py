...
READER_QUANTITIES: Dict[str, Dict[str, Tuple[str, list]]] = {
    ...
    "get_profile_fits": {
        ...
        "R": ("R", []),
        "z": ("z", []),
        "ne_rhop": ("electron_density", ["t", "rhop_fit"]),
        "te_rhop": ("electron_temperature", ["t", "rhop_fit"]),
        "pe_rhop": ("electron_pressure", ["t", "rhop_fit"]),
...
PLASMA_QUANTITIES = {
    "public_attrs": {
        ...
        "fast_ion_pressure_parallel": ("fast_ion_pressure_parallel", ["t", "rhop"]),
        "fast_ion_pressure_perpendicular": (
            "fast_ion_pressure_perpendicular",
            ["t", "rhop"],
        ),
    },
    "private_attrs": {
        "time_to_calculate": ("t", ["t"]),
        "rmag": ("R_mag", ["t"]),
        "zmag": ("z_mag", ["t"]),
        "pth": ("thermal_pressure_integral", ["t"]),
        "ptot": ("pressure_integral", ["t"]),
        ...
        "area": ("area", ["t", "rhop"]),
        "pressure": ("pressure", ["t", "rhop"]),
        "electron_pressure": ("electron_pressure", ["t", "rhop"]),
        "thermal_pressure": ("electron_pressure", ["t", "rhop"]),
        "fast_ion_pressure": ("fast_ion_pressure", ["t", "rhop"]),
