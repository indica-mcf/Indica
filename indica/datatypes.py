...
DATATYPES: Dict[str, Tuple[str, str]] = {
    ...
    "radial_field": ("$B_{r}$", "magnetic_field"),
    "vertical_field": ("$B_{z}$", "magnetic_field"),
    ...
    "total_fast_ion_pressure": (r"$P_{fast,tot}$", "pressure_density"),
