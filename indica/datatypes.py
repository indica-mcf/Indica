...
DATATYPES: Dict[str, Tuple[str, str]] = {
    ...
    "z": ("z", UNITS["length"]),
    "R": ("R", UNITS["length"]),
    "z_midplane": ("z-midplane", UNITS["length"]),
    "R_midplane": ("R-midplane", UNITS["length"]),
    "element": ("Element", UNITS["none"]),
    "residence_time": (r"$\tau$", UNITS["time"]),
    ...
    "total_pressure_integral": ("$P_{tot}", UNITS["pressure"]),
