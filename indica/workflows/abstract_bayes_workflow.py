...
class AbstractBayesWorkflow(ABC):
    ...
    def _build_result_dict(
        ...
        result["PHANTOMS"] = {
            ...
            "TFAST": self.plasma_context.phantom_profiles["fast_temperature"],
            "ZI": self.plasma_context.phantom_profiles["zeff"],
        ...
        result["PROFILES"] = {
            "PSI_NORM": {
                ...
                "TFAST": self.blobs["fast_temperature"].median(dim="index"),
                ...
                "ZI": self.blobs["zeff"].median(dim="index"),
                ...
                "TFAST_ERR": self.blobs["fast_temperature"].std(dim="index"),
                ...
                "ZI_ERR": self.blobs["zeff"].std(dim="index"),
            ...
            "R_MIDPLANE": {
                ...
                "TFAST": self.midplane_blobs["fast_temperature"].median(dim="index"),
                ...
                "ZI": self.midplane_blobs["zeff"].median(dim="index"),
                ...
                "TFAST_ERR": self.midplane_blobs["fast_temperature"].std(dim="index"),
                ...
                "ZI_ERR": self.midplane_blobs["zeff"].std(dim="index"),
            },
        }
        ...
        result["PROFILE_STAT"] = {
            ...
            "TFAST": self.blobs["fast_temperature"],
