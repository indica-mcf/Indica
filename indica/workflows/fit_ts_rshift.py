...
def fit_ts(
    ...
    print("  Te")
    te_fit, te_Rshift, te_rho = fit_profile_and_Rshift(
        ts_R,
        ts_z,
        te_data,
        te_err,
    ...
    print("  Ne")
    ne_fit, ne_Rshift, ne_rho = fit_profile_and_Rshift(
        ts_R,
        ts_z,
        ne_data,
        ne_err,
    ...
    te_fit.attrs["Rshift"] = te_Rshift
    ne_fit.attrs["Rshift"] = ne_Rshift
