"""Train on constant-imp expanded data and compare VAE vs naive per equilibrium context."""
...
@task(name="compare_vae_vs_naive_on_generated_equilibrium_contexts")
def compare_vae_vs_naive_on_generated_equilibrium_contexts_task(
    model_path: str,
    b_path: str,
    eps_path: str,
    output_dir: str,
...
@flow(name="multipulse_synthetic_expanded_equilibria_constant_imp_contextual_comparison")
def multipulse_synthetic_expanded_equilibria_constant_imp_contextual_comparison(
    machine: str = "st40",
    ...
    """
    Train/reuse VAE and compare VAE vs naive on freshly generated samples.
    ...
    Each generated comparison sample:
      ...
      4) compares VAE reconstruction (without explicit eq input) against naive inversion
    """
    ...
    comparison = compare_vae_vs_naive_on_generated_equilibrium_contexts_task(
        model_path=model_path,
        b_path=b_path,
        eps_path=eps_path,
...
if __name__ == "__main__":
    result = multipulse_synthetic_expanded_equilibria_constant_imp_contextual_comparison()
    print(result)
