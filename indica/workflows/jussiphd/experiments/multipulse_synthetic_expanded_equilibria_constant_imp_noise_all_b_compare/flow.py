...
@flow(name="multipulse_synthetic_expanded_equilibria_constant_imp_noise_all_b_contextual_comparison")
def multipulse_synthetic_expanded_equilibria_constant_imp_noise_all_b_contextual_comparison(
    machine: str = "st40",
...
if __name__ == "__main__":
    #result = multipulse_synthetic_expanded_equilibria_constant_imp_noise_all_b_contextual_comparison(vae_kl_scaling=0.5)
    #result = multipulse_synthetic_expanded_equilibria_constant_imp_noise_all_b_contextual_comparison(vae_kl_scaling=0.2)
    #result = multipulse_synthetic_expanded_equilibria_constant_imp_noise_all_b_contextual_comparison(vae_kl_scaling=0.1)
