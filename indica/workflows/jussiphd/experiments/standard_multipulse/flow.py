...
DEFAULT_OUTPUT_DIR = str(Path(__file__).resolve().parents[2] / "components" / "data")
...
def bolometry_inversion(
    ...
    vae_output_dir: str = str(Path(__file__).resolve().parents[2] / "components" / "ml"),
    ...
    visualisations_output_dir: str = str(Path(__file__).resolve().parent / "outputs"),
