...
# Expanded-equilibria dataset built from clustered-anchor synthetic eps with fixed impurities.
MULTIPULSE_SYNTHETIC_CLUSTERED_EXPANDED_EQUILIBRIA_CONSTANT_IMP_DATA_DIR = (
    DATASETS_ROOT / "multipulse_synthetic_clustered_expanded_equilibria_constant_imp"
)
MULTIPULSE_SYNTHETIC_CLUSTERED_EXPANDED_EQUILIBRIA_CONSTANT_IMP_DATA_DIR_STR = str(
    MULTIPULSE_SYNTHETIC_CLUSTERED_EXPANDED_EQUILIBRIA_CONSTANT_IMP_DATA_DIR
)
