...
BDA_NODES = {
    ...
    "PROFILES": {
        "PSI_NORM": {
            ...
            "TFAST": ("SIGNAL", "Fast ion temperature"),
            "ZI": ("SIGNAL", "Effective charge contribution of individual ion species"),
            ...
            "TFAST_ERR": ("SIGNAL", "Fast ion temperature error"),
            "ZI_ERR": ("SIGNAL", "Effective charge contribution of individual ion species error"),
    ...
    "PHANTOM": {
        ...
        "NI": ("SIGNAL", "Ion density"),
        "TE": ("SIGNAL", "Electron temperature"),
        "TI": ("SIGNAL", "Ion temperature of main ion"),
        "NNEUTR": ("SIGNAL", "Thermal neutral density"),
        "NFAST": ("SIGNAL", "Fast ion density"),
        "TFAST": ("SIGNAL", "Fast ion temperature"),
        "ZI": ("SIGNAL", "Effective charge contribution of individual ion species"),
