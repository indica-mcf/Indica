...
def bin_dataarray(
    ...
    Works with multi-dimensional data, preserving all dimensions except the binned coordinate.
    ...
    if is_tuple_format:
        ...
        return bin_by_boundaries(data, bins, coord_name=coord_name, labels=labels, reduce_func=reduce_func)
    else:
        # Use bin_by_edges for monotonically increasing edges
        return bin_by_edges(data, bins, coord_name=coord_name, labels=labels, reduce_func=reduce_func)
