...
if __name__ == "__main__":
    ...
    ).plot(fig=False, color="red", marker="o", label="monospline1")
    ...
    ).plot(fig=False, color="red", marker="x", label="monospline1")
    ...
    ).plot(fig=False, color="blue", marker="x", label="cubicspline1")
    plt.legend()
    plt.show(block=True)
